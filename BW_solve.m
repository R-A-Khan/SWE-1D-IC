function [b, T, Y] = BW_solve(h, dt, u0, tmin, tmax, x0_inds, trend, obs, eta, u_all, eta_all, T_obs, T_eta, nl)
% Usage: 
...
tRange = [tmin tmax];
[T,Y] = RK34_BW(dt, u0, tRange, trend, h, x0_inds, obs, eta, u_all, eta_all);
