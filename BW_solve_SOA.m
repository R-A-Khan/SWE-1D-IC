function [b, T, Y] = BW_solve_SOA(h, dt, u0, tmin, tmax, x0_inds, trend, eta_hat_x0, u_all, eta_all, u_adj, eta_adj, u_hat, eta_hat, T_obs, T_eta, nl)
% Usage: 
...
eta_hat = fliplr(eta_hat);
u_hat   = fliplr(u_hat);


tRange = [tmin tmax];
[T,Y] = RK34_BW_SOA(dt, u0, tRange, trend, h, x0_inds, eta_hat_x0, u_all, eta_all, u_adj, eta_adj, u_hat, eta_hat);
