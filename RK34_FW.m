function [t,y] = RK34_FW_tangent(dt, u0, tRange, trend, h, bath)
...
for k = 1 : numSteps
    ...
    U0 = y(:,k);
    U1 =  alpha(1,1)*U0                 + dt * beta(1,1)*trend(t,U0,h, bath);
    U2 =  alpha(2,2)*U1                 + dt * beta(2,2)*trend(t,U1,h, bath);
    U3 =  alpha(3,1)*U0 + alpha(3,3)*U2 + dt * beta(3,3)*trend(t,U2,h, bath);
    U4 =  alpha(4,4)*U3                 + dt * beta(4,4)*trend(t,U3,h, bath);
    y(:,k+1) = U4;
end